...
class Format
{
  ...
  /**
   * The default currency to use, if none is specified in the format() method.
   */
  public $currency;

  /**
   * Encode the UTF-8 characters into Numeric Character Reference format? 
   * Default: False
   */
  public $encode = False;
